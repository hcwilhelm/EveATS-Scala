...
trait Tables extends TypeMappers { self: HasJdbcDriver with Identifiers =>
  ...
  protected abstract class BaseTable[Entity](tag: Tag, schemaName: Option[String], tableName: String) extends Table[Entity](tag, schemaName, tableName) with CustomTypeMappers {
