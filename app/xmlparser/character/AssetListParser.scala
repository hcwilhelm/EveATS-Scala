...
//
//import models.eveapi.character.{AssetItem, AssetItemID, AssetListID}
...
//            val rawQuantity = Try {element.getAttributeByName(QNames.RAW_QUANTITY).getValue.toInt}.toOption
//
