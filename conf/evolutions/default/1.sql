...
alter table "eveats_character_asset_item" add constraint "id_asset_list_pk" primary key("id","asset_list_id");
...
alter table "eveats_character_asset_list" add constraint "id_affiliation_id_pk" primary key("id","affiliation_id");
create table "eveats_character_location" ("id" BIGINT NOT NULL PRIMARY KEY,"asset_list_id" BIGINT NOT NULL,"item_name" VARCHAR(254) NOT NULL,"x" DOUBLE PRECISION NOT NULL,"y" DOUBLE PRECISION NOT NULL,"z" DOUBLE PRECISION NOT NULL,"cached_until" TIMESTAMP NOT NULL);
alter table "eveats_character_location" add constraint "id_asset_list_id_pk" primary key("id","asset_list_id");
...
alter table "eveats_corporation_asset_item" add constraint "id_asset_list_pk" primary key("id","asset_list_id");
...
alter table "eveats_corporation_asset_list" add constraint "id_affiliation_id_pk" primary key("id","affiliation_id");
create table "eveats_corporation_location" ("id" BIGINT NOT NULL PRIMARY KEY,"asset_list_id" BIGINT NOT NULL,"item_name" VARCHAR(254) NOT NULL,"x" DOUBLE PRECISION NOT NULL,"y" DOUBLE PRECISION NOT NULL,"z" DOUBLE PRECISION NOT NULL,"cached_until" TIMESTAMP NOT NULL);
alter table "eveats_corporation_location" add constraint "id_asset_list_id_pk" primary key("id","asset_list_id");
...
alter table "eveats_character_asset_item" add constraint "asset_list_fk" foreign key("asset_list_id") references "eveats_character_asset_list"("id") on update CASCADE on delete CASCADE;
alter table "eveats_character_asset_list" add constraint "affiliation_fk" foreign key("affiliation_id") references "eveats_character"("id") on update CASCADE on delete CASCADE;
alter table "eveats_character_location" add constraint "asset_item_fk" foreign key("id") references "eveats_character_asset_item"("id") on update CASCADE on delete CASCADE;
...
alter table "eveats_corporation_asset_item" add constraint "asset_list_fk" foreign key("asset_list_id") references "eveats_corporation_asset_list"("id") on update CASCADE on delete CASCADE;
alter table "eveats_corporation_asset_list" add constraint "affiliation_fk" foreign key("affiliation_id") references "eveats_corporation"("id") on update CASCADE on delete CASCADE;
alter table "eveats_corporation_location" add constraint "asset_item_fk" foreign key("id") references "eveats_corporation_asset_item"("id") on update CASCADE on delete CASCADE;
...
alter table "eveats_corporation_asset_list" drop constraint "affiliation_fk";
alter table "eveats_corporation_asset_item" drop constraint "asset_list_fk";
...
alter table "eveats_character_asset_list" drop constraint "affiliation_fk";
alter table "eveats_character_asset_item" drop constraint "asset_list_fk";
...
alter table "eveats_corporation_location" drop constraint "id_asset_list_id_pk";
drop table "eveats_corporation_location";
alter table "eveats_corporation_asset_list" drop constraint "id_affiliation_id_pk";
drop table "eveats_corporation_asset_list";
alter table "eveats_corporation_asset_item" drop constraint "id_asset_list_pk";
...
alter table "eveats_character_location" drop constraint "id_asset_list_id_pk";
drop table "eveats_character_location";
alter table "eveats_character_asset_list" drop constraint "id_affiliation_id_pk";
drop table "eveats_character_asset_list";
alter table "eveats_character_asset_item" drop constraint "id_asset_list_pk";
